    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                let attr = $(this).attr("bookId");

                $.getJSON("http://localhost:8080/maven_web_war_exploded/cartServlet","action=ajaxAddItem&id=" + attr,function (data) {
                    $("#cartTotalCount").text("您的购物车中有" + data.totalCount + "件商品");
                    $("#cartLastName").text("您刚刚将" + data.lastName + "加入到了购物车中");

                });
                <%--location.href = "${pageScope.basePath}cartServlet?action=addItem&id=" + attr;--%>
            })
        })
    </script>
</head>
